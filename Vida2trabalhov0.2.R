...
calculo=function(){
  ...
  resultado[5,2]=valorfacebene*(tresvidasXZ[IdadeTitular+1,7]-duasvidasXZ[IdadeTitular+Diferimento+IdadeDependente+1,7])/duasvidasX[IdadeTitular+1,6]
  resultado[6,2]=valorfacebene*(tresvidasYZ[IdadeConjuge+1,7]-duasvidasYZ[IdadeConjuge+Diferimento+IdadeDependente+1,7])/duasvidasX[IdadeTitular+1,6]
  ...
  resultado[5,9]=valorfacebene*(tresvidasXZ[IdadeTitular+1,9])/(duasvidasXZZ[IdadeTitular+1,6])
